...
/**
 * @brief	Prints a formatted string to the UART
 * @param	same as for printf
 * @return	None
 */
...
//#define DEBUGOUT(...) printf(__VA_ARGS__)
#define DEBUGOUT(...) Board_UARTPrintf(__VA_ARGS__)
#define DEBUGSTR(str) Board_UARTPutSTR((char*)str)
