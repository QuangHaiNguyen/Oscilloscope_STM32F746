...
board_include_paths := \
	...
	$(touchgfx_path)/board/ST/STM32769I-EVAL/include \
	$(touchgfx_path)/board/ST/STM32769I-EVAL/include/vendor \
	$(touchgfx_path)/board/ST/STM32769I-EVAL/source/vendor/STM32F769I_EVAL \

c_compiler_options += -DST -DSTM32F769xx -DSTM32F769I_EVAL -DUSE_FREERTOS_8 -DUSE_OS_SYSTICK -DUSE_IOEXPANDER
cpp_compiler_options += -DST -DSTM32F769xx -DSTM32F769I_EVAL -DUSE_FREERTOS_8 -DUSE_OS_SYSTICK -DUSE_IOEXPANDER
