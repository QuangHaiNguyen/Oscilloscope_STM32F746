/**********************************************************************
* $Id: lpc18xx_adc.c 48117 2011-10-20 12:13:01Z anderslu $              lpc18xx_adc.c           2011-06-02
*//**
* @file         lpc18xx_adc.c
...
void ADC_Init(LPC_ADCn_Type *ADCx, uint32_t rate, uint8_t bits_accuracy)
{
         ...
         */
        temp = (temp /(rate * (bits_accuracy+1))) - 1;
        tmp |=  ADC_CR_CLKDIV(temp) | ADC_CR_BITACC(10 - bits_accuracy);
