/**********************************************************************
* $Id: lpc18xx_gpdma.c 48117 2011-10-20 12:13:01Z anderslu $            lpc18xx_gpdma.c         2011-06-02
*//**
...
volatile const void *GPDMA_LUTPerAddr[] = {
                ...
                (&LPC_SSP0->DR),                                // SSP0 Rx
                (&LPC_I2S->TXFIFO),                     // I2S channel 0
                (&LPC_SSP0->DR),                                // SSP0 Tx
                (&LPC_I2S->RXFIFO),                     // I2S channel 1
                (&LPC_SSP1->DR),                                // SSP1 Rx
                (&LPC_SSP1->DR),                                // SSP1 Tx
                (&LPC_ADC0->GDR),                               // ADC 0
                (&LPC_ADC1->GDR),                               // ADC 1
...
const uint32_t GPDMA_LUTPerAddr[] = {
                ...
                ((uint32_t)&LPC_I2S->TXFIFO),                   // I2S channel 0
                ((uint32_t)&LPC_SSP0->DR),                              // SSP0 Tx
                ((uint32_t)&LPC_I2S->RXFIFO),                   // I2S channel 1
