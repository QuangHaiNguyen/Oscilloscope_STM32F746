/**********************************************************************
* $Id: lpc18xx_timer.c 48117 2011-10-20 12:13:01Z anderslu $            lpc18xx_timer.c         2011-06-02
*//**
...
void TIM_Init(LPC_TIMERn_Type *TIMx, TIM_MODE_OPT TimerCounterMode, void *TIM_ConfigStruct)
{
        ...
        if (TIMx== LPC_TIMER0)
        {
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM0, ENABLE);
//              CGU_SetPCLKDiv (CGU_PCLKSEL_TIMER0, CGU_PCLKSEL_CCLK_DIV_4);
        }
        else if (TIMx== LPC_TIMER1)
        {
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM1, ENABLE);
//              CGU_SetPCLKDiv (CGU_PCLKSEL_TIMER1, CGU_PCLKSEL_CCLK_DIV_4);

        }

        else if (TIMx== LPC_TIMER2)
        {
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM2, ENABLE);
//              CGU_SetPCLKDiv (CGU_PCLKSEL_TIMER2, CGU_PCLKSEL_CCLK_DIV_4);
        }
        else if (TIMx== LPC_TIMER3)
        {
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM3, ENABLE);
//              CGU_SetPCLKDiv (CGU_PCLKSEL_TIMER3, CGU_PCLKSEL_CCLK_DIV_4);
...
void TIM_DeInit (LPC_TIMERn_Type *TIMx)
{
        ...
        // Disable power
//      if (TIMx== LPC_TIM0)
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM0, DISABLE);
//
//      else if (TIMx== LPC_TIM1)
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM1, DISABLE);
//
//      else if (TIMx== LPC_TIM2)
//              CGU_ConfigPPWR (CGU_PCONP_PCTIM2, DISABLE);
//
