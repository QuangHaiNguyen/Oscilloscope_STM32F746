/**********************************************************************
* $Id: lpc18xx_gpio.c 48117 2011-10-20 12:13:01Z anderslu $             lpc18xx_gpio.c          2011-06-02
*//**
* @file         lpc18xx_gpio.c
...
{
        LPC_GPIOn_Type *pGPIO = GPIO_GetPointer(portNum);
...
{
        LPC_GPIOn_Type *pFIO = GPIO_GetPointer(portNum);
