/**********************************************************************
* $Id: lpc18xx_i2s.c 48117 2011-10-20 12:13:01Z anderslu $              lpc18xx_i2s.c           2011-06-02
*//**
* @file         lpc18xx_i2s.c
...
static uint8_t i2s_GetWordWidth(LPC_I2S_Type *I2Sx, uint8_t TRMode);
static uint8_t i2s_GetChannel(LPC_I2S_Type *I2Sx, uint8_t TRMode);
 ...
 * @param[in]   I2Sx pointer to LPC_I2S_Type, should be: LPC_I2S
 ...
 * @return              none
 *********************************************************************/
void I2S_ModeConfig(LPC_I2S_Type *I2Sx, I2S_MODEConf_Type* ModeConfig,
                uint8_t TRMode)
{
        CHECK_PARAM(PARAM_I2Sx(I2Sx));
 ...
 * @return              none
 *********************************************************************/
void I2S_DMAConfig(LPC_I2S_Type *I2Sx, I2S_DMAConf_Type* DMAConfig,
                uint8_t TRMode)
{
        CHECK_PARAM(PARAM_I2Sx(I2Sx));
 ...
 * @return              none
 *********************************************************************/
void I2S_DMACmd(LPC_I2S_Type *I2Sx, uint8_t DMAIndex, uint8_t TRMode,
