...
static uint32_t CurrentLcd = USE_LCD_AM640480;//;USE_LCD_AM480272;
static uint32_t LCD_PIXEL_WIDTH  = 640;//480;
static uint32_t LCD_PIXEL_HEIGHT = 480;//272;
...
{ 
  ...
  {  
    ...
    */ 
    ...
    LTDC_Layer_InitStruct.LTDC_CFBStartAdress = 0x64000000;//LCD_FRAME_BUFFER;
    
    LTDC_LayerInit(LTDC_Layer1, &LTDC_Layer_InitStruct);
    
    /* Configure Layer2 */
    /* Start Address configuration : the LCD Frame buffer is defined on SDRAM w/ Offset */     
    LTDC_Layer_InitStruct.LTDC_CFBStartAdress = 0x64000000;//LCD_FRAME_BUFFER + BUFFER_OFFSET;
